	...
	<?php if ($categories) { ?>
	  <ul id="ullistcat">
		<?php foreach ($categories as $category) { ?>
			<li style="background-position:bottom;" <?php if($category['category_id'] == $category_id) { echo 'class="select"'; } ?>><a href="<?php echo $category['href']; ?>"><?php echo $category['name']; ?></a></li>
		<?php } ?>
	  </ul>
	<?php } ?>
    <?php if ($description) { ?>
