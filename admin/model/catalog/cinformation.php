...
class ModelCatalogcinformation extends Model {
	public function addcinformation($data) {
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "history SET user_id = '" . (int)$this->user->getId() . "', username = '" . $this->db->escape($this->user->getUserName()) . "', generic = 'cinformation_add', code = 'cinformation_id=" . (int)$cinformation_id . "', date_added = NOW()");
	...
	public function editcinformation($cinformation_id, $data) {
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "history SET user_id = '" . (int)$this->user->getId() . "', username = '" . $this->db->escape($this->user->getUserName()) . "', generic = 'cinformation_edit', code = 'cinformation_id=" . (int)$cinformation_id . "', date_added = NOW()");
