...
class ModelCatalogReview extends Model {
	public function addReview($data) {
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "history SET user_id = '" . (int)$this->user->getId() . "', username = '" . $this->db->escape($this->user->getUserName()) . "', generic = 'review_add', code = 'review_id=" . (int)$review_id . "', date_added = NOW()");
	}
	...
	public function editReview($review_id, $data) {
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "history SET user_id = '" . (int)$this->user->getId() . "', username = '" . $this->db->escape($this->user->getUserName()) . "', generic = 'review_edit', code = 'review_id=" . (int)$review_id . "', date_added = NOW()");
	}
