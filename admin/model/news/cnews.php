...
class ModelNewscnews extends Model {
	public function addcnews($data) {
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "history SET user_id = '" . (int)$this->user->getId() . "', username = '" . $this->db->escape($this->user->getUserName()) . "', generic = 'cnews_add', code = 'cnews_id=" . (int)$cnews_id . "', date_added = NOW()");
	...
	public function editcnews($cnews_id, $data) {
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "history SET user_id = '" . (int)$this->user->getId() . "', username = '" . $this->db->escape($this->user->getUserName()) . "', generic = 'cnews_edit', code = 'cnews_id=" . (int)$cnews_id . "', date_added = NOW()");
