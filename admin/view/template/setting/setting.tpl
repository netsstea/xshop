     ...
     <div id="tab_product">
      ...
      <div id="tab_local">
        <table class="form">
          <tr>
            ...
            <td><select name="config_country_id" id="country" onchange="$('#zone').load('index.php?route=setting/setting/zone&country_id=' + this.value + '&zone_id=<?php echo $config_zone_code; ?>');">
          ...
          <tr>
            ...
            <td><select name="config_zone_code" id="zone">
              </select></td>
          </tr>
          <tr>
      ...
      <div id="tab_image">
        <table class="form">
          ...
          <tr>
            <td>Logo Footer</td>
            <td><input type="hidden" name="config_logofooter" value="<?php echo $config_logofooter; ?>" id="config_logofooter" />
              <img src="<?php echo $preview_logofooter; ?>" alt="" id="preview_logofooter" style="border: 1px solid #EEEEEE;" />&nbsp;<img src="view/image/image.png" alt="" style="cursor: pointer;" align="top" onclick="image_upload('config_logofooter', 'preview_logofooter');" /></td>
          </tr>
          <tr>
            <td>Banner Footer</td>
            <td><input type="hidden" name="config_banner_footer" value="<?php echo $config_banner_footer; ?>" id="config_banner_footer" />
              <img src="<?php echo $preview_banner_footer; ?>" alt="" id="preview_banner_footer" style="border: 1px solid #EEEEEE;" />&nbsp;<img src="view/image/image.png" alt="" style="cursor: pointer;" align="top" onclick="image_upload('config_banner_footer', 'preview_banner_footer');" /></td>
          </tr>
          <tr>
            <td>Link Banner Footer</td>
            <td><input type="text" name="config_link_banner_footer" value="<?php echo $config_link_banner_footer; ?>" /></td>
          </tr>
          <tr>
...
$('#zone').load('index.php?route=setting/setting/zone&country_id=' + $('#country').attr('value') + '&zone_code=<?php echo $config_zone_code; ?>');

$('#country_id').attr('value', '<?php echo $config_country_id; ?>');
$('#zone_id').attr('value', '<?php echo $config_zone_code; ?>');
//--></script>
<script type="text/javascript"><!--
$.tabs('#tabs a');
$.tabs('#languages a');
