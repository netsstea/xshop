      ...
      <table class="list">
        <thead>
          <tr>
            ...
            <td class="right"><?php if ($sort == 'i.sort_order') { ?>
              ...
              <?php } ?></td>
			 <td class="right">Danh mục thông tin</td>
        ...
        <tbody>
          ...
          <tr>
			...
			<td class="right"><a href="<?php echo $information['cinformation_href']; ?>" target="_blank"><?php echo $information['cinformation_name']; ?></a> - <?php echo $information['cinformation_cshow']; ?></td>
