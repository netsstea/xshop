    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      ...
      <div id="language<?php echo $language['language_id']; ?>">
        <table class="form">
          <tr>
            ...
            <td><input size="46" name="chome_description[<?php echo $language['language_id']; ?>][name]" value="<?php echo isset($chome_description[$language['language_id']]) ? $chome_description[$language['language_id']]['name'] : ''; ?>" />
      ...
      <table class="form">
        ...
        <tr>
          ...
          <td><input name="link" value="<?php echo $link; ?>" size="46" /></td>
        </tr>
        <tr>
