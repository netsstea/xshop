...
<div class="box">
  ...
  <div class="content">
    <div id="tabs" class="tabs">
		...
		<a tab="#tab_attribute">Thông số</a>
		<a tab="#tab_option"><?php echo $tab_option; ?></a>
		<a tab="#tab_discount"><?php echo $tab_discount; ?></a>
		<a tab="#tab_special"><?php echo $tab_special; ?></a>
		<a tab="#tab_image"><?php echo $tab_image; ?></a>
		<a tab="#tab_video">Video</a></div>
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <div id="tab_general">
        ...
        <div id="language<?php echo $language['language_id']; ?>">
          <table class="form">
            ...
            <tr>
              <td>Tiêu đề SEO:<span class="help">Không biết thì đừng viết linh tinh.</span></td>
              <td><input size="55" type="text" name="product_description[<?php echo $language['language_id']; ?>][name_seo]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['name_seo'] : ''; ?>" />
              </td>
            </tr>
            <tr>
              <td>Meta mô tả:</td>
              <td><textarea name="product_description[<?php echo $language['language_id']; ?>][meta_description]" cols="60" rows="8"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['meta_description'] : ''; ?></textarea></td>
            </tr>
            <tr>
              <td><?php echo $entry_tags; ?></td>
              <td><textarea name="product_description[<?php echo $language['language_id']; ?>][tags]" cols="60" rows="8"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['tags'] : ''; ?></textarea></td>
            </tr>
            <tr>
            ...
            <tr>
			  <td><?php echo $entry_technical_description; ?><span class="help">Nội dung thêm trước hoặc thay thế thông số</span></td>
            ...
            <tr>
              <td>Khuyến mãi trị giá đến (đ)</td>
              <td><input size="30" type="text" name="total_promotion" value="<?php echo $total_promotion; ?>" />
              </td>
            </tr>
            <tr>
              <td>Khuyến mãi</td>
              <td><textarea name="product_description[<?php echo $language['language_id']; ?>][promotion]" id="promotion<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['promotion'] : ''; ?></textarea></td>
            </tr>
			
            <tr>
              <td>HCM Khuyến mãi trị giá đến (đ)</td>
              <td><input size="30" type="text" name="total_promotion_hc" value="<?php echo $total_promotion_hc; ?>" />
              </td>
            </tr>
            <tr>
              <td>HCM Khuyến mãi</td>
              <td><textarea name="product_description[<?php echo $language['language_id']; ?>][promotion_hc]" id="promotion_hc<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['promotion_hc'] : ''; ?></textarea></td>
            </tr>
          </table>
        </div>
        <?php } ?>
        ...
        <table class="form">
          <tr>
			...
			<td><select name="template">
				...
				<option value="templateSP1"<?php if($template=="templateSP1") { echo ' selected="selected"'; } ?>>Giao diện SP1</option>
			</select></td>
          </tr>
		  <tr>
			<td><?php echo $entry_image; ?></td>
			<td><input type="text" size="50" name="image" value="<?php echo $image; ?>" id="image" /><br/>
          ...
          <tr>
            ...
            <td><div class="scrollbox" style="height:200px;width:350px;">
                <?php $class = 'odd'; ?>
                <?php foreach ($categories as $category) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
                <div class="<?php echo $class; ?><?php if(!strpos($category['name'],$text_separator)) { echo " pl_top";} ?>">
                  <?php if (in_array($category['category_id'], $product_category)) { ?>
					<input type="checkbox" name="product_category[]" value="<?php echo $category['category_id']; ?>" checked="checked" />
					<?php echo $category['name']; ?>
				   <?php } elseif($category['category_id'] == $category_id) { ?>
					<input type="checkbox" name="product_category[]" value="<?php echo $category['category_id']; ?>" checked="checked" />
					<?php echo $category['name']; ?>
                  <?php } else { ?>
         ...
         <tr>
            <td>Bộ lọc sản phẩm</td>
            <td><div class="scrollbox" style="height:200px;width:350px;">
                <?php $class = 'odd'; ?>
                <?php foreach ($phanloais as $phanloai) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
                <div class="<?php echo $class; ?><?php if(!strpos($phanloai['name'],$text_separator)) { echo " pl_top";} ?>">
                  <?php if (in_array($phanloai['phanloai_id'], $product_phanloai)) { ?>
                  <input type="checkbox" name="product_phanloai[]" value="<?php echo $phanloai['phanloai_id']; ?>" checked="checked" />
                  <?php echo $phanloai['name']; ?>
                  <?php } else { ?>
				  <?php if(strpos($phanloai['name'],$text_separator)) { ?>
                  <input type="checkbox" name="product_phanloai[]" value="<?php echo $phanloai['phanloai_id']; ?>" />
				  <?php } ?>
                  <?php echo $phanloai['name']; ?>
                  <?php } ?>
                </div>
          ...
          <tr>
            ...
            <td><div class="scrollbox">
                ...
                <div class="<?php echo $class; ?>">
                  <?php if (in_array($chome['chome_id'], $product_chome)) { ?>
                  <input type="checkbox" name="product_chome[]" value="<?php echo $chome['chome_id']; ?>" checked="checked" />
                  <?php echo $chome['name']; ?>
                  <?php } else { ?>
                  <input type="checkbox" name="product_chome[]" value="<?php echo $chome['chome_id']; ?>" />
                  <?php echo $chome['name']; ?>
                  <?php } ?>
                </div>
                <?php } ?>
          ...
          <tr>
            <td><?php echo $entry_price; ?> HCM</td>
            <td><input type="text" name="price_hc" value="<?php echo $price_hc; ?>" /></td>
          </tr>
          <tr>
            <td>Sắp xếp</td>
          ...
          <tr>
            <td>Phụ kiện cho sản phẩm</td>
            <td><table>
                <tr>
                  <td style="padding: 0;" colspan="3"><select id="categorypk" style="margin-bottom: 5px;" onchange="getProductpks();">
                      <?php foreach ($phukiens as $category) { ?>
                      <option value="<?php echo $category['category_id']; ?>"><?php echo $category['name']; ?></option>
                      <?php } ?>
                    </select></td>
                </tr>
                <tr>
                  <td style="padding: 0;"><select multiple="multiple" id="productpk" size="10" style="width: 300px;">
                    </select></td>
                  <td style="vertical-align: middle;"><input type="button" value="--&gt;" onclick="addPhukien();" />
                    <br />
                    <input type="button" value="&lt;--" onclick="removePhukien();" /></td>
                  <td style="padding: 0;"><select multiple="multiple" id="phukien" size="10" style="width: 300px;">
                    </select></td>
                </tr>
              </table>
              <div id="product_phukien">
                <?php foreach ($product_phukien as $phukien_id) { ?>
                <input type="hidden" name="product_phukien[]" value="<?php echo $phukien_id; ?>" />
                <?php } ?>
              </div></td>
          </tr>
          <tr>
            ...
            <td><table>
                ...
                <tr>
                  <td style="padding: 0;"><select multiple="multiple" id="product" size="10" style="width: 300px;">
                    </select></td>
                  ...
                  <td style="padding: 0;"><select multiple="multiple" id="related" size="10" style="width: 300px;">
                    </select></td>
                </tr>
              </table>
          ...
          <tr>
            <td><span style="color:#F00;">HCM</span> <?php echo $entry_stock_status; ?></td>
            <td><select name="stock_status_id_hc">
                <?php foreach ($stock_statuses as $stock_status) { ?>
                <?php if ($stock_status['stock_status_id'] == $stock_status_id_hc) { ?>
                <option value="<?php echo $stock_status['stock_status_id']; ?>" selected="selected"><?php echo $stock_status['name']; ?></option>
                <?php } else { ?>
                <option value="<?php echo $stock_status['stock_status_id']; ?>"><?php echo $stock_status['name']; ?></option>
                <?php } ?>
			  ...
			  <tr>
				...
				<?php for($j = 0; $j < sizeof($attribute); $j++) { ?>
					<tr>
						...
						<td class="atdr<?php echo ' atrTop' . ($j+1); ?>"><input type="hidden" name="product_attribute[<?php echo $k; ?>][attribute_id]" value="<?php echo $attribute[$j]['attribute_id']; ?>"  /><input type="text" name="product_attribute[<?php echo $k; ?>][text]" value="<?php echo $attribute[$j]['text']; ?>"  /></td>
					</tr>
					<?php $k++; ?>
				<?php } ?>
				</tbody></table></td>
          ...
          <tbody>
            <tr class="filter">
              ...
              <td class="left"><select>
				...
				<option value="0" selected="selected"><?php echo $text_no; ?></option></select>
			  </td>
              ...
              <tbody>
                <tr>
                  <td class="left"><?php foreach ($languages as $language) { ?>
                    ...
                    <?php } ?></td>
					<td class="left">
						<select name="product_option[<?php echo $option_row; ?>][color_status]">
						  <?php if ($product_option['color_status']) { ?>
              ...
              <tbody id="option_value_row<?php echo $option_value_row; ?>">
                <tr>
                  <td class="left"><?php foreach ($languages as $language) { ?>
                    ...
                    <?php } ?></td>
				  <td class="left">
					<select name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][color_id]">
					  <option value="0" selected="selected"><?php echo $text_none; ?></option>
              ...
              <tbody id="option_row<?php echo $option_row; ?>">
                <tr class="filter">
                  <td class="left"><?php foreach ($languages as $language) { ?>
                    ...
                    <?php } ?></td>
				  <td class="left">
					<select id="product_option_<?php echo $option_row; ?>_product_option_value_color_id">
					  <option value="0" selected="selected"><?php echo $text_none; ?></option>
					  <?php foreach ($colors as $color) { ?>
					  <option value="<?php echo $color['color_id']; ?>"><?php echo $color['name']; ?></option>
					  <?php } ?>
          ...
          <tbody id="discount">
            <tr class="filter">
              <td class="left"><select id="discount_customer_group_id">
                  <?php foreach ($customer_groups as $customer_group) { ?>
                  <option value="<?php echo $customer_group['customer_group_id']; ?>" <?php if($config_customer_group_id == $customer_group['customer_group_id']) { echo 'selected="selected"';} ?>><?php echo $customer_group['name']; ?></option>
                  <?php } ?>
                </select></td>
          ...
          <tbody id="special">
            <tr class="filter">
              <td class="left"><select id="special_customer_group_id">
                  <?php foreach ($customer_groups as $customer_group) { ?>
                  <option <?php if($config_customer_group_id == $customer_group['customer_group_id']) { echo 'selected="selected"';} ?> value="<?php echo $customer_group['customer_group_id']; ?>"><?php echo $customer_group['name']; ?></option>
                  <?php } ?>
                </select></td>
      ...
      <div id="tab_image">
        <table id="images" class="list">
          <thead>
            <tr>
              <td class="left"  style="width:130px;"><?php echo $entry_image; ?></td>
			  <td>Link hình</td>
			  <td>Thông tin hình</td>
			  <td>Chọn là Slideshow</td>
			  <td>Chọn màu</td>
			  <td>Sắp xếp</td>
              <td></td>
            </tr>
          ...
          <tbody id="image_row<?php echo $image_row; ?>">
            <tr>
              ...
              <td class="left"><input size="55" type="text" name="product_image[<?php echo $image_row; ?>][image]" value="<?php echo $product_image['file']; ?>" id="image<?php echo $image_row; ?>"  />
			  </td>
              <td class="left" style="width:447px;"><div id="slide_status_1" class="1slst_<?php echo $image_row; ?><?php if ($product_image['slide_status']) { echo ' active';} ?>">
			  <div style="width:80px;float:left;">Tiêu đề hình</div> <input size="55" type="text" name="product_image[<?php echo $image_row; ?>][title_image]" value="<?php echo $product_image['title_image']; ?>" /><br/>
			  
			  <div style="width:80px;float:left;">Mô tả hình</div>  <textarea cols="57" rows="3" name="product_image[<?php echo $image_row; ?>][description_image]"><?php echo $product_image['description_image']; ?></textarea>
			  </div>
			  </td>
			  <td class="left">
				<select name="product_image[<?php echo $image_row; ?>][slide_status]" id="slide_status" class="slst_<?php echo $image_row; ?>">
				  <?php if ($product_image['slide_status']) { ?>
				  <option value="1" selected="selected"><?php echo $text_yes; ?></option>
				  <option value="0"><?php echo $text_no; ?></option>
				  <?php } else { ?>
				  <option value="1"><?php echo $text_yes; ?></option>
              ...
              <td class="left"><select name="product_image[<?php echo $image_row; ?>][color_id]">
				  <option value="0" selected="selected"><?php echo $text_none; ?></option>
                  <?php foreach ($colors as $color) { ?>
                  <?php if ($color['color_id'] == $product_image['color_id']) { ?>
                  <option value="<?php echo $color['color_id']; ?>" selected="selected"><?php echo $color['name']; ?></option>
                  <?php } else { ?>
                  <option value="<?php echo $color['color_id']; ?>"><?php echo $color['name']; ?></option>
                  <?php } ?>
				...
				<td class="left"><input type="text" name="product_image[<?php echo $image_row; ?>][sort_order]" value="<?php echo $product_image['sort_order']; ?>" size="5" /></td>
      ...
      <div id="tab_video">
        <table id="videos" class="list">
          <thead>
            <tr>
              <td class="left">Nhập Link Youtube</td>
              <td></td>
            </tr>
          </thead>
          <?php $video_row = 0; ?>
          <?php foreach ($product_videos as $product_video) { ?>
          <tbody id="video_row<?php echo $video_row; ?>">
            <tr>
              <td class="left"><input size="50" type="text" name="product_video[<?php echo $video_row; ?>]" value="<?php echo $product_video['video']; ?>" id="video<?php echo $video_row; ?>"  /></td>
              <td class="left"><a onclick="$('#video_row<?php echo $video_row; ?>').remove();" class="button"><span><?php echo $button_remove; ?></span></a></td>
            </tr>
          </tbody>
          <?php $video_row++; ?>
          <?php } ?>
        ...
        <br />
        <a onclick="addvideo();" class="button"><span>Thêm Video</span></a>
	  </div>
    </form>
  </div>
</div>
...
toolbar: 'Custom',
toolbar_Custom: [
		['Bold','Italic','Underline','Strike','TextColor','Image']
	]
});
CKEDITOR.replace('technical_description<?php echo $language['language_id']; ?>', {
toolbar: 'Custom',
toolbar_Custom: [
		['Bold','Italic','Underline','Strike','TextColor','Image','Table']
	]
});
CKEDITOR.replace('promotion<?php echo $language['language_id']; ?>', {
height: '100px',
toolbar: 'Custom',
toolbar_Custom: [
...
CKEDITOR.replace('promotion_hc<?php echo $language['language_id']; ?>', {
height: '100px',
toolbar: 'Custom',
toolbar_Custom: [
		['Bold','Italic','Underline','Strike','TextColor']
...
<script type="text/javascript"><!--
function addPhukien() {
	$('#productpk :selected').each(function() {
		$(this).remove();
		
		$('#phukien option[value=\'' + $(this).attr('value') + '\']').remove();
		
		$('#phukien').append('<option value="' + $(this).attr('value') + '">' + $(this).text() + '</option>');
		
		$('#product_phukien input[value=\'' + $(this).attr('value') + '\']').remove();
		
		$('#product_phukien').append('<input type="hidden" name="product_phukien[]" value="' + $(this).attr('value') + '" />');
	});
}

function removePhukien() {
	$('#phukien :selected').each(function() {
		$(this).remove();
...
function getProductpks() {
	$('#productpk option').remove();
	
	$.ajax({
		url: 'index.php?route=catalog/product/category&category_id=' + $('#categorypk').attr('value'),
		dataType: 'json',
		success: function(data) {
			for (i = 0; i < data.length; i++) {
	 			$('#productpk').append('<option value="' + data[i]['product_id'] + '">' + data[i]['name'] + '</option>');
			}
		}
	});
}
...
function getPhukien() {
	$('#phukien option').remove();
	
	$.ajax({
		url: 'index.php?route=catalog/product/phukien',
		type: 'POST',
		dataType: 'json',
		data: $('#product_phukien input'),
		success: function(data) {
			$('#product_phukien input').remove();
			
			for (i = 0; i < data.length; i++) {
	 			$('#phukien').append('<option value="' + data[i]['product_id'] + '">' + data[i]['name'] + '</option>');
				
				$('#product_phukien').append('<input type="hidden" name="product_phukien[]" value="' + data[i]['product_id'] + '" />');
			} 
		}
	});
}
...
function addOption() {	
	...
	html += '<td class="left">Giá theo màu</td>';
	...
	<?php } ?>
	html += '</td>';
    html += '<td class="left"><select name="product_option[' + option_row + '][color_status]">';
    ...
    <?php } ?>
	html += '</td>';
    html += '<td class="left"><select id="product_option_' + option_row + '_product_option_value_color_id">';
	html += '<option value="0" selected="selected"><?php echo $text_none; ?></option>';
    <?php foreach ($colors as $color) { ?>
    html += '<option value="<?php echo $color['color_id']; ?>"><?php echo $color['name']; ?></option>';
    <?php } ?>
    html += '</select></td>';
...
function addOptionValue(option_id) {
	...
	<?php } ?>
	html += '</td>';
    html += '<td class="left"><select name="product_option[' + option_id + '][product_option_value][' + option_value_row + '][color_id]">';
	html += '<option value="0" selected="selected"><?php echo $text_none; ?></option>';
    <?php foreach ($colors as $color) { ?>
    html += '<option value="<?php echo $color['color_id']; ?>"><?php echo $color['name']; ?></option>';
    <?php } ?>
...
function addDiscount() {
    ...
    <?php foreach ($customer_groups as $customer_group) { ?>
    html += '<option value="<?php echo $customer_group['customer_group_id']; ?>" <?php if($config_customer_group_id == $customer_group['customer_group_id']) { echo 'selected="selected"';} ?>><?php echo $customer_group['name']; ?></option>';
    <?php } ?>
    html += '</select></td>';		
...
function addSpecial() {
    ...
    <?php foreach ($customer_groups as $customer_group) { ?>
    html += '<option <?php if($config_customer_group_id == $customer_group['customer_group_id']) { echo 'selected="selected"';} ?> value="<?php echo $customer_group['customer_group_id']; ?>"><?php echo $customer_group['name']; ?></option>';
    <?php } ?>
    html += '</select></td>';		
...
function addImage() {
	...
	html += '<tr>';
	html += '<td class="left"><img src="<?php echo $no_image; ?>" alt="" id="preview' + image_row + '" style="margin: 4px 0px; border: 1px solid #EEEEEE;" />&nbsp;<img src="view/image/image.png" alt="" style="cursor: pointer;" align="top" onclick="image_upload(\'image' + image_row + '\', \'preview' + image_row + '\');" /></td><td class="left"><input type="text" size="55" name="product_image[' + image_row + '][image]" value="" id="image' + image_row + '" /></td>';
	html += '<td class="left" style="width:447px;"><div id="slide_status_1" class="1slst_' + image_row + '">';
    html += '<div style="width:80px;float:left;">Tiêu đề hình</div> <input size="55" type="text" name="product_image[' + image_row + '][title_image]" value="" /><br/>';
    html += '<div style="width:80px;float:left;">Mô tả hình</div>  <textarea cols="57" rows="3" name="product_image[' + image_row + '][description_image]"></textarea>';
    html += '</div></td>';	
	html += '<td class="left"><select name="product_image[' + image_row + '][slide_status]" id="slide_status" class="slst_' + image_row + '">';
    html += '<option value="1"><?php echo $text_yes; ?></option>';
    html += '<option value="0" selected="selected"><?php echo $text_no; ?></option>';
    html += '</select></td>';
    html += '<td class="left"><select name="product_image[' + image_row + '][color_id]" id="product_image_' + image_row + '_color_id">';
	html += '<option value="0" selected="selected"><?php echo $text_none; ?></option>';
    <?php foreach ($colors as $color) { ?>
    html += '<option value="<?php echo $color['color_id']; ?>"><?php echo $color['name']; ?></option>';
    <?php } ?>
    html += '</select></td>';
	html += '<td class="left"><input type="text" name="product_image[' + image_row + '][sort_order]" id="product_image_' + image_row + '_sort_order" value="" size="5" /></td>';
...
function addvideo() {
    html  = '<tbody id="video_row' + video_row + '">';
	html += '<tr>';
	html += '<td class="left"><input size="50" type="type" name="product_video[' + video_row + ']" value="" id="video' + video_row + '" /></td>';
	html += '<td class="left"><a onclick="$(\'#video_row' + video_row  + '\').remove();" class="button"><span><?php echo $button_remove; ?></span></a></td>';
	html += '</tr>';
	html += '</tbody>';
...
<script type="text/javascript"><!--
$(document).ready(function(){
	$('td #slide_status').each(function(i, element) {
	var hpclass = $(element).attr("class");
		$("." + hpclass).change(function(){
			var id=$("." + hpclass).val();
			if(id == 1) {
				$('.1' + hpclass).addClass('active');
			}
			if(id == 0) {
				var stst = hpclass.split('_');
				$('.1' + hpclass).removeClass('active');
				$('input[name=\'product_image['+stst[1]+'][title_image]\']').val('');
				$('textarea[name=\'product_image['+stst[1]+'][description_image]\']').val('');
			}
		});
	});
});
