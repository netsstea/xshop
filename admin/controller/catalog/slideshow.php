...
class ControllerCatalogslideshow extends Controller { 
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			...
			foreach ($this->request->post['selected'] as $slideshow_id) {
				...
				$list = $list . '_' . $slideshow_id;
			}
			
			$this->model_user_history->addHistory('slideshow_delete','slideshow_id=' . $list);
	...
	private function getForm() {
		...
		if (isset($this->request->post['sshow'])) {
			$this->data['sshow'] = $this->request->post['sshow'];
		} elseif (isset($slideshow_info)) {
			$this->data['sshow'] = $slideshow_info['sshow'];
		} else {
			$this->data['sshow'] = '';
		}
		
		if (isset($this->request->get['sshow'])) {
			$this->data['sshow'] = $this->request->get['sshow'];
		}
