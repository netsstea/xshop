	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			...
			foreach ($this->request->post['selected'] as $cinformation_id) {
				...
				$list = $list . '_' . $cinformation_id;
			}
			
			$this->model_user_history->addHistory('cinformation_delete','cinformation_id=' . $list);
	...
	private function getList() {
    	...
    	foreach ($results as $result) {
			...
			$this->data['cinformations'][] = array(
				...
				'cshow' 	 => $this->model_tool_info->infotocshow($result['cshow']),
