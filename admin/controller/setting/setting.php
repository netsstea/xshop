...
class ControllerSettingSetting extends Controller {
	...
	public function index() { 
		...
		if (isset($this->request->post['config_zone_code'])) {
			$this->data['config_zone_code'] = $this->request->post['config_zone_code'];
		} else {
			$this->data['config_zone_code'] = $this->config->get('config_zone_code');
		}
		...
		$this->data['config_banner_footer'] = $this->config->get('config_banner_footer');

		if ($this->config->get('config_banner_footer') && file_exists(DIR_IMAGE . $this->config->get('config_banner_footer'))) {
			if ((isset($this->request->server['HTTPS'])) && ($this->request->server['HTTPS'] == 'on')) {
				$this->data['preview_banner_footer'] = HTTPS_IMAGE . $this->config->get('config_banner_footer');
			} else {
				$this->data['preview_banner_footer'] = HTTP_IMAGE . $this->config->get('config_banner_footer');
			}			
		} else {
			$this->data['preview_banner_footer'] = image_resize('no_image.jpg', 100, 100);
		}
		
		if (isset($this->request->post['config_link_banner_footer'])) {
			$this->data['config_link_banner_footer'] = $this->request->post['config_link_banner_footer'];
		} else {
			$this->data['config_link_banner_footer'] = $this->config->get('config_link_banner_footer');
		}
		
		$this->data['config_logofooter'] = $this->config->get('config_logofooter');

		if ($this->config->get('config_logofooter') && file_exists(DIR_IMAGE . $this->config->get('config_logofooter'))) {
			if ((isset($this->request->server['HTTPS'])) && ($this->request->server['HTTPS'] == 'on')) {
				$this->data['preview_logofooter'] = HTTPS_IMAGE . $this->config->get('config_logofooter');
			} else {
				$this->data['preview_logofooter'] = HTTP_IMAGE . $this->config->get('config_logofooter');
			}			
		} else {
			$this->data['preview_logofooter'] = image_resize('no_image.jpg', 100, 100);
		}
	...
	public function zone() {
		...
		foreach ($results as $result) {
			...
			if (isset($this->request->get['zone_code']) && ($this->request->get['zone_code'] == $result['code'])) {
