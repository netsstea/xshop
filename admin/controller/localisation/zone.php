...
class ControllerLocalisationZone extends Controller {
	...
	private function getForm() {
		...
		if (isset($this->request->post['showroom_status'])) {
			$this->data['showroom_status'] = $this->request->post['showroom_status'];
		} elseif (isset($zone_info)) {
			$this->data['showroom_status'] = $zone_info['showroom_status'];
		} else {
			$this->data['showroom_status'] = 0;
		}
