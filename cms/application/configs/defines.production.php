...
define('SITE_URL', 'http://tindiem.com/');
define('MOBILE_URL', 'http://m.tindiem.com/');

//define('SITE_URL', 'http://www.oakq.com');
define('SAND_ASSETS_CDN', 'http://bao30.com/');
define('ASSETS_CDN', 'http://tindiem.com/assets/');

define('STATIC_CDN', 'http://s.tindiem.com/');
define('STATIC_PATH', PUBLIC_PATH . '/ufiles/');

define('USERFILES_CDN', 'http://s.tindiem.com/');
define('USERFILES_PATH', PUBLIC_PATH . '/ufiles/');


define('NOREPLY_EMAIL', 'noreply@tindiem.com');
define('DOMAIN', 'tindiem.com');
define('CONTACT_EMAIL', 'contact@tindiem.com');
 ...
 * File upload & path
 */
define('DEFAULT_AVATAR_URL',SAND_ASSETS_CDN . '/images/avatar.gif');
define('SYSTEM_AVATAR_URL', SAND_ASSETS_CDN . '/images/warning.jpg');
...
define('PUBLIC_FILES_UPLOAD_PATH', realpath(APPLICATION_PATH . "/../") . "/public/" . CODENAME . "/ufiles");
