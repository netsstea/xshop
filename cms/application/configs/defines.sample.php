...
define('REDIS_PASS', '');
define('REDIS_DB', 0);
//define('DICT_RDB_PREFIX', 'dict:');
define('DICT_RDB_PREFIX', '');
...
define('RDB_QUEUE_DB', 2); // prefix for all queue-related keys
