...
define('SITE_URL', 'http://news.local');
define('MOBILE_URL', 'http://newsmobile.local/');
define('SITE_DESC', 'Chuyên trang tin tức tiếng anh trực tuyến hàng đầu Việt Nam');
//define('SITE_URL', 'http://www.oakq.com');
define('SAND_ASSETS_CDN', 'http://sandassets.local/');
define('ASSETS_CDN', 'http://newsassets.local/');

define('STATIC_CDN', 'http://newsstatic.local/');
define('STATIC_PATH', PUBLIC_PATH . '/ufiles/');

define('USERFILES_CDN', 'http://newsstatic.local/');
define('USERFILES_PATH', PUBLIC_PATH . '/ufiles/');


define('NOREPLY_EMAIL', 'hoibinet@gmail.com');
define('DOMAIN', 'news.local');
...
define('PUBLIC_AVATAR_UPLOAD_PATH', realpath(PUBLIC_PATH ) . "/ufiles/avatar/");
