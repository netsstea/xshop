<?php 
class Source_Form_Search extends Cl_Form_Search
{
...
//    			'required' => true,
    		...
    		'op' => '$in',
    		'multiOptionsCallback' => array(array('Source_Form_Helper', 'getStatus')),
        ...
        'category' => array(
                ...
                'multiOptionsCallback' => array(array('Source_Form_Helper', 'getCategoryTreeSlug')),
        		'$op' => '$eq'
        ),
    	'name' => array(
    		'type' => 'Text',
        ...
        'type' => array(
        		'type' => 'MultiCheckbox',
        		'options' => array(
        			'label' => t('source_type', 1),
        			'disableLoadDefaultDecorators' => false,
        			'required' => true,
        			'filters' => array('StringTrim', 'StripTags')
        		),
        		'multiOptions' => array('1' => 'source', '2' => 'Image', '3' => 'video', '4' => 'Links'),
