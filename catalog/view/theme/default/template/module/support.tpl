<?php if($support_position == 'taskbar') { ?>
<?php if($code) { ?>
	...
	<table align="center" border="0" cellpadding="0" cellspacing="0" class="hotro">
		...
		<?php foreach ($csupport['supports'] as $support) { ?>
			...
			<tr>
				...
				<a href="ymsgr:sendIM?<?php echo $support['yahoo_id']; ?>"><img align="left"  src="http://opi.yahoo.com/online?u=<?php echo $support['yahoo_id']; ?>&m=g&t=5&l=us" /></a>
				</td>
				<td align="center" class="tdtop"><?php echo $support['name']; ?></td>
			</tr>
			<tr>
				<td align="left" width="12" class="tdbottom" <?php if(sizeof($csupport['supports']) != 1 && sizeof($csupport['supports']) != $i) { echo 'style="border-bottom:1px solid #DADADA;"'; } ?>>
				...
				<td align="right" class="tdbottom" <?php if(sizeof($csupport['supports']) != 1 && sizeof($csupport['supports']) != $i) { echo 'style="border-bottom:1px solid #DADADA;"'; } ?>>
