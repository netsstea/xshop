...
class ControllerAccountLogin extends Controller {
	...
	public function index() {
		...
		if(isset($this->request->get['route'])){
			if($this->request->get['route'] == 'checkout/cart') {
				$this->data['cart_select'] = true;
			} else {
				$this->data['cart_select'] = false;
			}
		} else {
			$this->data['cart_select'] = false;
		}
		...
		if (isset($this->request->get['options'])) {
			$this->data['options'] = $this->request->get['options'];
		} else {
	...
	public function login() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			if (isset($this->session->data['ordercontinue'])) {
				unset($this->session->data['ordercontinue']);
			}
