<?php
/*/Khai bao dang nhap
$config['usename_dnp'] = 'letam';
$config['password_dnp'] = '1289326b62a3693904a762df113bf795';

if ($_SERVER['PHP_AUTH_USER'] != $config['usename_dnp'] || md5($_SERVER['PHP_AUTH_PW']) != $config['password_dnp']){
...
echo '<center>Ban khong co quyen vao trang thong tin nay!</center>';
exit;
}
*/
// Configuration
...
if (!defined('HTTP_SERVER')) {
	header('Location: install1/index.php');
	exit;
} 
...
require_once(DIR_SYSTEM . 'library/zone.php');
